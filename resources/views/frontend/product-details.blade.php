                ...
                <div class="p-l-25 p-r-30 p-lr-0-lg">
                    <div class="wrap-slick3 flex-sb flex-w">
                        ...
                        <div class="slick3 gallery-lb">
                            ...
                            <div class="item-slick3" data-thumb="{{$productImage->product_image}}">
                                <div class="wrap-pic-w pos-relative">
                                    <img src="{{$productImage->product_image}}" alt="IMG-PRODUCT">

                                    <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{$productImage->product_image}}">
                                        <i class="fa fa-expand"></i>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="p-t-33">
                                ...
                                <div class="size-204 respon6-next">
                                    <div class="rs1-select2 bor8 bg0">
                                        <select class="js-select2" name="color_id">
                                            ...
                                            <option value="{{$color->color_id}}">{{$color->color->color}}</option>
                                            @endforeach
                                        </select>
                                        <div class="dropDownSelect2"></div>
                                    </div>
                            ...
                            <div class="flex-w flex-r-m p-b-10">
                                <div class="size-204 flex-w flex-m respon6-next">
                                    ...
                                    <div style='color:red; padding: 0 5px;'>{{($errors->has('qty'))?($errors->first('qty')):''}}</div>
