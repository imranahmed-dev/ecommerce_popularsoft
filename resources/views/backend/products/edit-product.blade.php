                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control myselect2" name="category_id">
                                                ...
                                                <option value="{{$category->id}}" {{ old('category_id') == $category->id ? 'selected' : '' }} @if($product->category_id == $category->id) selected @endif>{{$category->name}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <option value="">Select Brand</option>
                                                ...
                                                <option value="{{$brand->id}}" {{ old('brand_id') == $brand->id ? 'selected' : '' }} @if($product->brand_id == $brand->id) selected @endif>{{$brand->name}}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="summernote" name="short_desc">{{$product->short_desc}}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" placeholder="Price" name="price" class="form-control" value="{{$product->price}}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <img style="padding:4px;border:1px solid gray; margin: 10px 0; width:100px;" id="showNoImage" src="{{asset($product->image)}}" alt="image">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <img style="padding:4px;border:1px solid gray; margin: 10px 0; width:100px;"  src="{{asset($productImage->product_image)}}" alt="image">
                                            @endforeach
